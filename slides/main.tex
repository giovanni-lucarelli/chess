...
\begin{frame}{Dynamic Programming}
  \includegraphics[\textwidth]{images/ValueIteration.png}
  \begin{itemize}
  KRk: 182.676 states
  KQk:
  KBBk
...
\begin{frame}{What if the adversary is a casual player?}
\end{frame}

\begin{frame}{Q-Learning}

  \includegraphics[\textwidth]{images/Q-learning.png}

\end{frame}

\begin{frame}{Full Reinforcement Learning}
  \includegraphics[\textwidth]{images/AlphaZero.png}
\end{frame}
