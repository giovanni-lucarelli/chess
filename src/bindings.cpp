...
PYBIND11_MODULE(chessengine_py, m) {
    ...
    py::class_<ChessBoard>(m, "ChessBoard")
        ...
        .def("get_board", &ChessBoard::get_board)
        .def("get_pieces", &ChessBoard::get_pieces)
        .def("get_piece_on_square", &ChessBoard::get_piece_on_square)
        .def("set_side_to_move", &ChessBoard::set_side_to_move)
        .def("set_en_passant_square", &ChessBoard::set_en_passant_square)
        .def("set_castling_rights", &ChessBoard::set_castling_rights)
        .def("get_side_to_move", &ChessBoard::get_side_to_move)
        .def("get_en_passant_square", &ChessBoard::get_en_passant_square)
        .def("get_castling_rights", &ChessBoard::get_castling_rights)
        .def("get_check", &ChessBoard::get_check)
